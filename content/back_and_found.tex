...
We query samples to our oracle directly from our input space or create new samples we then query. This comes 
both with advantages and challenges. QSAL is not being bound to a fixed pool-size, and thereby fixed to a 
finite amount of samples, allows more versatile sampling. 
The flexibility is also the key challenge. We have to decide, which 
samples we want to query~\cite{wang2015active}. 
In this work, we will use Markov chain Monte Carlo as sampling method.
