...
AL4PDE is an active learning framework in which an ensemble of neural networks approximates the solution trajectories of a PDE. The trainings data consits of a specific PDE with the associated parameters and initial conditions, paired with the belonging solution trajectorie. The solution is provided by a numerical scheme, depending on the PDE. 
