...
The gradient information allows us to either sample from the complete underlying distribution, or even sample more often from samples with higher uncertainty.
